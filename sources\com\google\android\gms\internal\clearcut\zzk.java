    ...
    public static long zza(byte[] bArr) {
        ...
        if (length <= 32) {
            if (length > 16) {
                ...
                long j3 = (((long) ((bArr[0] & UByte.MAX_VALUE) + ((bArr[(length >> 1) + 0] & UByte.MAX_VALUE) << 8))) * -7286425919675154353L) ^ (((long) (length + ((bArr[(length - 1) + 0] & UByte.MAX_VALUE) << 2))) * -4348849565147123417L);
