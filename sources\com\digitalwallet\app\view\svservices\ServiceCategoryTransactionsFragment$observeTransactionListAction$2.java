...
public final class ServiceCategoryTransactionsFragment$observeTransactionListAction$2 extends Lambda implements Function1<SVTransaction, Unit> {
    final /* synthetic */ HomeServicesFragment $homeServicesFragment;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ServiceCategoryTransactionsFragment$observeTransactionListAction$2(HomeServicesFragment homeServicesFragment) {
        super(1);
    ...
    public final void invoke(SVTransaction sVTransaction) {
        ...
        if (homeServicesFragment != null) {
            homeServicesFragment.openURL(sVTransaction.getUrl(), sVTransaction.getId());
        }
    }
}
