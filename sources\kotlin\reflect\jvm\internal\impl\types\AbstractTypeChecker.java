...
public final class AbstractTypeChecker {
    ...
    private final boolean isSubtypeOfForSingleClassifierType(AbstractTypeCheckerContext abstractTypeCheckerContext, SimpleTypeMarker simpleTypeMarker, SimpleTypeMarker simpleTypeMarker2) {
        ...
        if (checkSubtypeForIntegerLiteralType != null) {
            ...
            AbstractTypeCheckerContext.addSubtypeConstraint$default(abstractTypeCheckerContext, simpleTypeMarker3, simpleTypeMarker4, false, 4, null);
            return booleanValue;
        }
        ...
        if (!z3 && isSubtypeForSameConstructor(abstractTypeCheckerContext, argumentList, simpleTypeMarker2)) {
            return true;
        }
    ...
    public final boolean isSubtypeForSameConstructor(AbstractTypeCheckerContext abstractTypeCheckerContext, TypeArgumentListMarker typeArgumentListMarker, SimpleTypeMarker simpleTypeMarker) {
        boolean z;
        Intrinsics.checkNotNullParameter(abstractTypeCheckerContext, "$this$isSubtypeForSameConstructor");
            ...
            if (!abstractTypeCheckerContext.isStarProjection(argument)) {
                ...
                if (abstractTypeCheckerContext.argumentsDepth <= 100) {
                    ...
                    if (i2 == 1) {
                        ...
                        z = isSubtypeOf$default(INSTANCE, abstractTypeCheckerContext, type2, type, false, 8, null);
                    } else if (i2 == 3) {
                        z = isSubtypeOf$default(INSTANCE, abstractTypeCheckerContext, type, type2, false, 8, null);
                    } else {
        ...
        if (abstractTypeCheckerContext.isError(simpleTypeMarker3) || abstractTypeCheckerContext.isError(simpleTypeMarker2)) {
            ...
            if (!(supertypes instanceof Collection) || !supertypes.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (!isSubtypeOf$default(INSTANCE, abstractTypeCheckerContext, simpleTypeMarker3, it.next(), false, 8, null)) {
                        break;
                    }
                }
