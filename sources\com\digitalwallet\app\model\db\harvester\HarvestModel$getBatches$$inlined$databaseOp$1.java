...
public final class HarvestModel$getBatches$$inlined$databaseOp$1<T> implements SingleOnSubscribe<T> {
    final /* synthetic */ HarvestModel this$0;

    public HarvestModel$getBatches$$inlined$databaseOp$1(HarvestModel harvestModel) {
    ...
    public final void subscribe(final SingleEmitter<T> singleEmitter) {
        ...
        new AsyncTask<Void, Void, Void>(this) {
            /* class com.digitalwallet.app.model.db.harvester.HarvestModel$getBatches$$inlined$databaseOp$1.AnonymousClass1 */
            final /* synthetic */ HarvestModel$getBatches$$inlined$databaseOp$1 this$0;

            {
                this.this$0 = r1;
            }

            /* JADX DEBUG: Multi-variable search result rejected for r2v3, resolved type: io.reactivex.SingleEmitter */
            /* JADX WARN: Multi-variable type inference failed */
            /* access modifiers changed from: protected */
            public Void doInBackground(Void... voidArr) {
                Intrinsics.checkNotNullParameter(voidArr, "params");
                try {
                    singleEmitter.onSuccess(this.this$0.this$0.database.harvestTagBatchDao().getAll());
                    return null;
                } catch (Throwable th) {
