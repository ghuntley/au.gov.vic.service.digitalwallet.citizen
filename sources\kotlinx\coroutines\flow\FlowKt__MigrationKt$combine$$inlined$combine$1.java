...
public final class FlowKt__MigrationKt$combine$$inlined$combine$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object combineInternal = CombineKt.combineInternal(flowCollector, this.$flows$inlined, new Function0<Object[]>(this) {
            /* class kotlinx.coroutines.flow.FlowKt__MigrationKt$combine$$inlined$combine$1.AnonymousClass2 */
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        new ContinuationImpl(this, continuation) {
            /* class kotlinx.coroutines.flow.FlowKt__MigrationKt$combine$$inlined$combine$1.AnonymousClass1 */
            int label;
