...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static long[] m214constructorimpl(long[] jArr) {
        Intrinsics.checkNotNullParameter(jArr, "storage");
        return jArr;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m217equalsimpl(long[] jArr, Object obj) {
        return (obj instanceof ULongArray) && Intrinsics.areEqual(jArr, ((ULongArray) obj).m228unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m218equalsimpl0(long[] jArr, long[] jArr2) {
    ...
    public static int m221hashCodeimpl(long[] jArr) {
        if (jArr != null) {
    ...
    public static String m225toStringimpl(long[] jArr) {
    ...
    public boolean m226addVKZWuLQ(long j) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean m227containsVKZWuLQ(long j) {
        return m215containsVKZWuLQ(this.storage, j);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m227containsVKZWuLQ(((ULong) obj).m211unboximpl());
        }
        return false;
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long[] m213constructorimpl(int i) {
        return m214constructorimpl(new long[i]);
    }

    /* renamed from: get-s-VKNKU  reason: not valid java name */
    public static final long m219getsVKNKU(long[] jArr, int i) {
        return ULong.m168constructorimpl(jArr[i]);
    }

    /* renamed from: set-k8EXiF4  reason: not valid java name */
    public static final void m224setk8EXiF4(long[] jArr, int i, long j) {
        jArr[i] = j;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m220getSizeimpl(long[] jArr) {
        return jArr.length;
    }

    /* renamed from: iterator-impl  reason: not valid java name */
    public static ULongIterator m223iteratorimpl(long[] jArr) {
    ...
    public static final class Iterator extends ULongIterator {
        ...
        public long m229nextULongsVKNKU() {
            int i = this.index;
    ...
    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public static boolean m215containsVKZWuLQ(long[] jArr, long j) {
        return ArraysKt.contains(jArr, j);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m216containsAllimpl(long[] jArr, Collection<ULong> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, "elements");
        Collection<ULong> collection2 = collection;
        if (!collection2.isEmpty()) {
            for (T t : collection2) {
                if (!(t instanceof ULong) || !ArraysKt.contains(jArr, t.m211unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
    ...
    public static boolean m222isEmptyimpl(long[] jArr) {
