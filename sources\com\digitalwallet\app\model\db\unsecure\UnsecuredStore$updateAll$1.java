...
public final class UnsecuredStore$updateAll$1<V> implements Callable<Object> {
    final /* synthetic */ UnsecuredHoldingRoom[] $roomHoldings;
    final /* synthetic */ UnsecuredStore this$0;

    UnsecuredStore$updateAll$1(UnsecuredStore unsecuredStore, UnsecuredHoldingRoom[] unsecuredHoldingRoomArr) {
    ...
    public final void call() {
        ...
        unsecuredHoldingDao.updateAll((UnsecuredHoldingRoom[]) Arrays.copyOf(unsecuredHoldingRoomArr, unsecuredHoldingRoomArr.length));
    }
}
