        ...
        if (zza2 != null) {
            ...
            if (j == 0) {
                ...
                if (string == null || string.isEmpty()) {
                    ...
                    Bundle zza3 = zzh.zza(Uri.parse(valueOf.length() != 0 ? "?".concat(valueOf) : new String("?")));
                    if (zza3 == null) {
                        ...
                        if (j == zzfl.zza.zzb().zzi.zza()) {
                            ...
                            zzfl.zza.zzg().zza(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, Constants.ScionAnalytics.EVENT_FIREBASE_CAMPAIGN, zza3);
                        }
                    }
                }
            }
