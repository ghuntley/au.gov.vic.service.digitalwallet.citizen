...
public final class zzab extends zzgr {
    ...
    public final List<String> zzg(String str) {
        ...
        if (zzz == null) {
            ...
            try {
                String[] stringArray = zzm().getResources().getStringArray(num.intValue());
                if (stringArray == null) {
                    return null;
                }
    ...
    public final String zza(zzf zzf) {
        ...
        if (TextUtils.isEmpty(zze)) {
            if (zznv.zzb() && zzs().zzd(zzf.zzc(), zzas.zzbi)) {
                zze = zzf.zzg();
            }
            zze = zzf.zzf();
        }
        ...
        encodedAuthority.path(valueOf.length() != 0 ? "config/app/".concat(valueOf) : new String("config/app/")).appendQueryParameter("app_instance_id", zzf.zzd()).appendQueryParameter("platform", AbstractSpiCall.ANDROID_CLIENT_TYPE).appendQueryParameter("gmp_version", "33025");
