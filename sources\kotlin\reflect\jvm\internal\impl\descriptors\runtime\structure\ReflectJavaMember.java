    ...
    public final List<JavaValueParameter> getValueParameters(Type[] typeArr, Annotation[][] annotationArr, boolean z) {
        ...
        while (i < length) {
            ...
            if (loadParameterNames != null) {
                ...
                if (str == null) {
                    throw new IllegalStateException(("No parameter with index " + i + SignatureVisitor.EXTENDS + size + " (name=" + getName() + " type=" + create + ") in " + loadParameterNames + "@ReflectJavaMember").toString());
                }
            } else {
                str = null;
            }
