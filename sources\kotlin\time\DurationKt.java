...
public final class DurationKt {
    ...
    private static final double m1328timesmvk6XK0(int i, double d) {
        return Duration.m1308timesUwyO8pc(d, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final double m1327timeskIfJnKk(double d, double d2) {
        return Duration.m1307timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkNotNullParameter(timeUnit, "unit");
        return Duration.m1281constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
