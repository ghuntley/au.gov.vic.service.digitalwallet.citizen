...
public class X962NamedCurves {
    static X9ECParametersHolder c2pnb163v1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m(Opcodes.IF_ICMPGT, 1, 2, 8, new BigInteger("072546B5435234A422E0789675F432C89435DE5242", 16), new BigInteger("00C9517D06D5240D3CFF38C74B20B6CD4D6F9DD4D9", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2pnb163v2 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            ECCurve.F2m f2m = new ECCurve.F2m(Opcodes.IF_ICMPGT, 1, 2, 8, new BigInteger("0108B39E77C4B108BED981ED0E890E117C511CF072", 16), new BigInteger("0667ACEB38AF4E488C407433FFAE4F1C811638DF20", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2pnb163v3 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            ECCurve.F2m f2m = new ECCurve.F2m(Opcodes.IF_ICMPGT, 1, 2, 8, new BigInteger("07A526C63D3E25A256A007699F5447E32AE456B50E", 16), new BigInteger("03F7061798EB99E238FD6F1BF95B48FEEB4854252B", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2pnb176w1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m(Opcodes.ARETURN, 1, 2, 43, new BigInteger("00E4E6DB2995065C407D9D39B8D0967B96704BA8E9C90B", 16), new BigInteger("005DDA470ABE6414DE8EC133AE28E9BBD7FCEC0AE0FFF2", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2tnb191v1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            ECCurve.F2m f2m = new ECCurve.F2m((int) Opcodes.ATHROW, 9, new BigInteger("2866537B676752636A68F56554E12640276B649EF7526267", 16), new BigInteger("2E45EF571F00786F67B0081B9495A3D95462F5DE0AA185EC", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2tnb191v2 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m((int) Opcodes.ATHROW, 9, new BigInteger("401028774D7777C7B7666D1366EA432071274F89FF01E718", 16), new BigInteger("0620048D28BCBD03B6249C99182B7C8CD19700C362C46A01", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2tnb191v3 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m((int) Opcodes.ATHROW, 9, new BigInteger("6C01074756099122221056911C77D77E77A777E7E7E77FCB", 16), new BigInteger("71FE1AF926CF847989EFEF8DB459F66394D90F32AD3F15E8", 16), bigInteger, valueOf);
