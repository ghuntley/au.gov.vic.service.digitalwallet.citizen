...
public final class CombineKt$combineTransformInternal$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        SelectBuilderImpl selectBuilderImpl4 = new SelectBuilderImpl(combineKt$combineTransformInternal$232);
        SelectBuilderImpl selectBuilderImpl22 = selectBuilderImpl4;
        z = booleanRef.element;
        SelectBuilderImpl selectBuilderImpl32 = selectBuilderImpl4;
        CombineKt$combineTransformInternal$2 combineKt$combineTransformInternal$242 = combineKt$combineTransformInternal$232;
        CombineKt$combineTransformInternal$2 combineKt$combineTransformInternal$252 = combineKt$combineTransformInternal$2;
        ...
        z2 = booleanRef2.element;
        CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$3 combineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$32 = new CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$3(null, combineKt$combineTransformInternal$252, booleanRef, receiveChannel52, objectRef62, objectRef3, booleanRef2, receiveChannel62);
        if (!z2) {
        }
        result = selectBuilderImpl32.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
        }
        if (result == obj2) {
        }
        ...
        SelectBuilderImpl selectBuilderImpl42 = new SelectBuilderImpl(combineKt$combineTransformInternal$2322);
        SelectBuilderImpl selectBuilderImpl222 = selectBuilderImpl42;
        z = booleanRef.element;
        SelectBuilderImpl selectBuilderImpl322 = selectBuilderImpl42;
        CombineKt$combineTransformInternal$2 combineKt$combineTransformInternal$2422 = combineKt$combineTransformInternal$2322;
        CombineKt$combineTransformInternal$2 combineKt$combineTransformInternal$2522 = combineKt$combineTransformInternal$2;
        ...
        z2 = booleanRef2.element;
        CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$3 combineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$322 = new CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$3(null, combineKt$combineTransformInternal$2522, booleanRef, receiveChannel522, objectRef622, objectRef3, booleanRef2, receiveChannel622);
        if (!z2) {
        }
        result = selectBuilderImpl322.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
        }
        if (result == obj2) {
        }
