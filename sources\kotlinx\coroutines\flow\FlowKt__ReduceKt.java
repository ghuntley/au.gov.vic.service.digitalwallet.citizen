            ...
            if ((flowKt__ReduceKt$firstOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    try {
                        ...
                        if (flow.collect(new FlowKt__ReduceKt$firstOrNull$$inlined$collect$1(objectRef2), flowKt__ReduceKt$firstOrNull$1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } catch (AbortFlowException unused) {
                    }
            ...
            if ((flowKt__ReduceKt$firstOrNull$3.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    try {
                        ...
                        if (flow.collect(new FlowKt__ReduceKt$firstOrNull$$inlined$collect$2(function2, objectRef2), flowKt__ReduceKt$firstOrNull$3) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } catch (AbortFlowException unused) {
                    }
