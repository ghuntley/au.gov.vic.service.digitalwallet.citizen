...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static int[] m144constructorimpl(int[] iArr) {
    ...
    public static final int m149getpVg5ArA(int[] iArr, int i) {
    ...
    public static final class Iterator extends UIntIterator {
        ...
        public int m159nextUIntpVg5ArA() {
            int i = this.index;
            int[] iArr = this.array;
            if (i < iArr.length) {
                this.index = i + 1;
    ...
    public static boolean m146containsAllimpl(int[] iArr, Collection<UInt> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, "elements");
        Collection<UInt> collection2 = collection;
        if (!collection2.isEmpty()) {
            for (T t : collection2) {
                if (!(t instanceof UInt) || !ArraysKt.contains(iArr, t.m141unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
