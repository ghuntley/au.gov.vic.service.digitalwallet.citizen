...
public final class UStringsKt {
    ...
    public static final String m1267toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1269toStringolVBNx4(short s, int i) {
    ...
    public static final String m1268toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1266toStringJSWoG40(long j, int i) {
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m307unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m211unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m141unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m98constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m24boximpl(UByte.m30constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m141unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m98constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m260boximpl(UShort.m266constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m327uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m168constructorimpl((long) i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m329ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m168constructorimpl(j2 * r9);
            long r4 = ULong.m168constructorimpl(ULong.m168constructorimpl(((long) UInt.m98constructorimpl(digitOf)) & 4294967295L) + r11);
