...
public final class SharingHistoryFragmentViewModel$getShares$2$$special$$inlined$sortedByDescending$1<T> implements Comparator<T> {
    @Override // java.util.Comparator
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(Long.valueOf(t2.getShareTime()), Long.valueOf(t.getShareTime()));
    }
}
