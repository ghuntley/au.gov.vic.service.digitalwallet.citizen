...
import com.digitalwallet.app.databinding.HarvesterZoneBinding;
...
import com.digitalwallet.app.viewmodel.harvester.HarvestZoneAdapter;
...
public final class HarvestJobWizardZoneFragment extends BaseAppFragment<HarvesterZoneBinding> implements HarvestJobFragment {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        RecyclerView recyclerView = ((HarvesterZoneBinding) getBinding()).zoneTable;
        recyclerView.setLayoutManager(new LinearLayoutManager(recyclerView.getContext()));
        HarvestZoneAdapter harvestZoneAdapter = new HarvestZoneAdapter(getViewModel());
        harvestZoneAdapter.notifyDataSetChanged();
        Unit unit = Unit.INSTANCE;
        recyclerView.setAdapter(harvestZoneAdapter);
    }
}
