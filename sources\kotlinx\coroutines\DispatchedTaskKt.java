...
public final class DispatchedTaskKt {
    ...
    public static final <T> void resume(DispatchedTask<? super T> dispatchedTask, Continuation<? super T> continuation, int i) {
        ...
        if (exceptionalResult$kotlinx_coroutines_core == null) {
            ...
            exceptionalResult$kotlinx_coroutines_core = StackTraceRecoveryKt.access$recoverFromStackFrame(exceptionalResult$kotlinx_coroutines_core, (CoroutineStackFrame) continuation);
        }
        if (exceptionalResult$kotlinx_coroutines_core != null) {
        ...
        Object r3 = Result.m12constructorimpl(obj);
        if (i == 0) {
            continuation.resumeWith(r3);
        } else if (i == 1) {
            DispatchedContinuationKt.resumeCancellableWith(continuation, r3);
        } else if (i != 2) {
