...
public final class AnalyticsKt {
    ...
    public static final void setConsent(FirebaseAnalytics firebaseAnalytics, Function1<? super zza, Unit> function1) {
        Intrinsics.checkNotNullParameter(firebaseAnalytics, "$this$setConsent");
        Intrinsics.checkNotNullParameter(function1, "block");
        function1.invoke(new zza());
        firebaseAnalytics.setConsent(new LinkedHashMap());
    }
}
