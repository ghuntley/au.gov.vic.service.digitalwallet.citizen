...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1330plusAssignLRDsOJo(double d) {
        long j;
        double r0 = Duration.m1313toDoubleimpl(d, getUnit());
        long j2 = (long) r0;
    ...
    private final void m1329overflowLRDsOJo(double d) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m1319toStringimpl(d) + '.');
    }
}
