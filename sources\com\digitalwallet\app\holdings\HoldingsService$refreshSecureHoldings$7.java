...
public final class HoldingsService$refreshSecureHoldings$7<V> implements Callable<List<? extends SecureHolding>> {
    public static final HoldingsService$refreshSecureHoldings$7 INSTANCE = new HoldingsService$refreshSecureHoldings$7();

    HoldingsService$refreshSecureHoldings$7() {
    }
