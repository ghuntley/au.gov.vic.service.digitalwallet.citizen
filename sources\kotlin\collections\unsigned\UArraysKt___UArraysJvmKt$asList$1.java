...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m463containsWZ4Q5Ns(((UInt) obj).m141unboximpl());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ UInt get(int i) {
        return UInt.m92boximpl(m464getpVg5ArA(i));
    }

    @Override // kotlin.collections.AbstractList
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UInt) {
            return m465indexOfWZ4Q5Ns(((UInt) obj).m141unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UInt) {
            return m466lastIndexOfWZ4Q5Ns(((UInt) obj).m141unboximpl());
        }
        return -1;
    }
    ...
    public boolean m463containsWZ4Q5Ns(int i) {
        return UIntArray.m145containsWZ4Q5Ns(this.$this_asList, i);
    }

    /* renamed from: get-pVg5ArA  reason: not valid java name */
    public int m464getpVg5ArA(int i) {
        return UIntArray.m149getpVg5ArA(this.$this_asList, i);
    }

    /* renamed from: indexOf-WZ4Q5Ns  reason: not valid java name */
    public int m465indexOfWZ4Q5Ns(int i) {
        return ArraysKt.indexOf(this.$this_asList, i);
    }

    /* renamed from: lastIndexOf-WZ4Q5Ns  reason: not valid java name */
    public int m466lastIndexOfWZ4Q5Ns(int i) {
