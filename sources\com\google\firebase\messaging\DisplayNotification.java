...
public class DisplayNotification {
    ...
    private void showNotification(CommonNotificationBuilder.DisplayNotificationInfo displayNotificationInfo) {
        ...
        ((NotificationManager) this.context.getSystemService(HoldingExpiryPublisher.NOTIFICATION_KEY)).notify(displayNotificationInfo.tag, displayNotificationInfo.id, displayNotificationInfo.notificationBuilder.build());
    }
}
