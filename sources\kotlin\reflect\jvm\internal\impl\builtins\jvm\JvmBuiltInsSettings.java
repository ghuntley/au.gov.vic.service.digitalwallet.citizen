...
public class JvmBuiltInsSettings implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    public Collection<KotlinType> getSupertypes(ClassDescriptor classDescriptor) {
        ...
        if (companion.isArrayOrPrimitiveArray(fqNameUnsafe)) {
            ...
            list = CollectionsKt.listOf((Object[]) new KotlinType[]{cloneableType, this.mockSerializableType});
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x0117, code lost:
        if (r2 != 3) goto L_0x0138;
     */
    /* JADX WARNING: Removed duplicated region for block: B:40:0x0144  */
    /* JADX WARNING: Removed duplicated region for block: B:47:0x00c4 A[SYNTHETIC] */
    @Override // kotlin.reflect.jvm.internal.impl.descriptors.deserialization.AdditionalClassPartsProvider
        ...
        if (Intrinsics.areEqual(name, CloneableClassScope.Companion.getCLONE_NAME()) && (classDescriptor instanceof DeserializedClassDescriptor) && KotlinBuiltIns.isArrayOrPrimitiveArray(classDescriptor)) {
            ...
            if (!(list instanceof Collection) || !list.isEmpty()) {
                ...
                while (true) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(next, "functionProto");
            ...
            for (T t : getAdditionalFunctions(classDescriptor, new JvmBuiltInsSettings$getFunctions$2(name))) {
                ...
                if (i == 1) {
                    if (!ModalityKt.isFinalClass(classDescriptor)) {
                        Intrinsics.checkNotNullExpressionValue(newCopyBuilder.setHiddenForResolutionEverywhereBesideSupercalls(), "setHiddenForResolutionEverywhereBesideSupercalls()");
                    }
                    if (simpleFunctionDescriptor == null) {
                        arrayList.add(simpleFunctionDescriptor);
                    }
                } else if (i == 2) {
                    Intrinsics.checkNotNullExpressionValue(newCopyBuilder.setAdditionalAnnotations(getNotConsideredDeprecation()), "setAdditionalAnnotations(notConsideredDeprecation)");
                }
    ...
    public Collection<ClassConstructorDescriptor> getConstructors(ClassDescriptor classDescriptor) {
        ...
        for (ClassConstructorDescriptor classConstructorDescriptor : arrayList2) {
            ...
            if (!WHITE_LIST_CONSTRUCTOR_SIGNATURES.contains(SignatureBuildingComponents.INSTANCE.signature(lazyJavaClassDescriptor, MethodSignatureMappingKt.computeJvmDescriptor$default(classConstructorDescriptor, false, false, 3, null)))) {
