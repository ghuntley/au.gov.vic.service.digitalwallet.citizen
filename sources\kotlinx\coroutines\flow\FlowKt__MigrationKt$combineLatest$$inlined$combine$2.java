...
public final class FlowKt__MigrationKt$combineLatest$$inlined$combine$2 implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object combineInternal = CombineKt.combineInternal(flowCollector, this.$flows$inlined, new Function0<Object[]>(this) {
            /* class kotlinx.coroutines.flow.FlowKt__MigrationKt$combineLatest$$inlined$combine$2.AnonymousClass2 */
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        new ContinuationImpl(this, continuation) {
            /* class kotlinx.coroutines.flow.FlowKt__MigrationKt$combineLatest$$inlined$combine$2.AnonymousClass1 */
            int label;
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$combineLatest$$inlined$combine$2$3", f = "Migration.kt", i = {0, 0, 0, 0, 1, 1}, l = {StatusLine.HTTP_PERM_REDIRECT, 309}, m = "invokeSuspend", n = {"$receiver", "it", "continuation", "args", "$receiver", "it"}, s = {"L$0", "L$1", "L$2", "L$3", "L$0", "L$1"})
