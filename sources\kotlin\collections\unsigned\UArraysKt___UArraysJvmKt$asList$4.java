...
public final class UArraysKt___UArraysJvmKt$asList$4 extends AbstractList<UShort> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m475containsxj2QHRw(((UShort) obj).m307unboximpl());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ UShort get(int i) {
        return UShort.m260boximpl(m476getMh2AYeg(i));
    }

    @Override // kotlin.collections.AbstractList
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UShort) {
            return m477indexOfxj2QHRw(((UShort) obj).m307unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UShort) {
            return m478lastIndexOfxj2QHRw(((UShort) obj).m307unboximpl());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UShortArray.m316getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection
    public boolean isEmpty() {
        return UShortArray.m318isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-xj2QHRw  reason: not valid java name */
    public boolean m475containsxj2QHRw(short s) {
        return UShortArray.m311containsxj2QHRw(this.$this_asList, s);
    }

    /* renamed from: get-Mh2AYeg  reason: not valid java name */
    public short m476getMh2AYeg(int i) {
        return UShortArray.m315getMh2AYeg(this.$this_asList, i);
    }

    /* renamed from: indexOf-xj2QHRw  reason: not valid java name */
    public int m477indexOfxj2QHRw(short s) {
        return ArraysKt.indexOf(this.$this_asList, s);
    }

    /* renamed from: lastIndexOf-xj2QHRw  reason: not valid java name */
    public int m478lastIndexOfxj2QHRw(short s) {
