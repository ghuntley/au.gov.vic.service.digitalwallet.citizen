...
final /* synthetic */ class zzbb {
    ...
    static {
        int[] iArr = new int[zzcx.zzd.zzce().length];
        zzct = iArr;
        iArr[zzcx.zzd.zzapj - 1] = 1;
        zzct[zzcx.zzd.zzapk - 1] = 2;
        zzct[zzcx.zzd.zzapi - 1] = 3;
        zzct[zzcx.zzd.zzapl - 1] = 4;
        zzct[zzcx.zzd.zzapm - 1] = 5;
        zzct[zzcx.zzd.zzapg - 1] = 6;
        zzct[zzcx.zzd.zzaph - 1] = 7;
    }
}
