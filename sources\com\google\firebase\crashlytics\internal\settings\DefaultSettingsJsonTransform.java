...
public class DefaultSettingsJsonTransform implements SettingsJsonTransform {
    ...
    static Settings defaultSettings(CurrentTimeProvider currentTimeProvider) {
        ...
        return new SettingsData(getExpiresAtFrom(currentTimeProvider, 3600, jSONObject), null, buildSessionDataFrom(jSONObject), buildFeaturesSessionDataFrom(jSONObject), 0, 3600);
    }
