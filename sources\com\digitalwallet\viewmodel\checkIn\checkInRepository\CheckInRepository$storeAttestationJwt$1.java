...
public final class CheckInRepository$storeAttestationJwt$1 extends Lambda implements Function1<CheckInCookie, Unit> {
    final /* synthetic */ AttestationJwt $item;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CheckInRepository$storeAttestationJwt$1(AttestationJwt attestationJwt) {
        super(1);
        this.$item = attestationJwt;
    }
    ...
    public final void invoke(CheckInCookie checkInCookie) {
        ...
        checkInCookie.setAttestation(this.$item);
    }
}
