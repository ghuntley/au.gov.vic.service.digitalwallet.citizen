...
public class Grainv1Engine implements StreamCipher {
    ...
    private int getOutput() {
        ...
        int i16 = i12 & i15;
        int i17 = i15 & i8;
        return (((((((((i8 & i14) ^ ((i17 ^ (i16 ^ (((i13 ^ i14) ^ (i12 & i8)) ^ ((i9 & i10) & i11)))) ^ ((i10 & i11) & i8))) ^ i) ^ i2) ^ i3) ^ i4) ^ i5) ^ i6) ^ i7) & SupportMenu.USER_MASK;
    }
    ...
    private int getOutputLFSR() {
        ...
        return (((iArr[4] << 2) | (iArr[3] >>> 14)) ^ ((((((iArr[0] >>> 13) | (iArr[1] << 3)) ^ i) ^ i2) ^ i3) ^ ((iArr[3] >>> 3) | (iArr[4] << 13)))) & SupportMenu.USER_MASK;
    }
    ...
    private int getOutputNFSR() {
        ...
        int i16 = i7 & i6 & i5;
        return (((((((((i12 & i9) & i6) & i2) ^ (i15 ^ i16)) ^ ((i14 & i8) & i7)) ^ ((i13 & i5) & i4)) ^ (((i13 & i10) & i9) & i8)) ^ ((i4 & i16) & i2)) ^ (((((i10 & i9) & i8) & i7) & i6) & i5)) & SupportMenu.USER_MASK;
    }
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                int i3 = i2 + 1;
                iArr[i] = ((bArr3[i2] & UByte.MAX_VALUE) | (bArr3[i3] << 8)) & SupportMenu.USER_MASK;
                int[] iArr2 = this.lfsr;
                byte[] bArr4 = this.workingIV;
                iArr2[i] = ((bArr4[i2] & UByte.MAX_VALUE) | (bArr4[i3] << 8)) & SupportMenu.USER_MASK;
                i2 += 2;
                i++;
            } else {
                return;
