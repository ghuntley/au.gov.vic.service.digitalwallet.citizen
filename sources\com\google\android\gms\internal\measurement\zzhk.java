...
final class zzhk implements zzlm {
    ...
    private zzhk(zzhi zzhi) {
        zzhi zzhi2 = (zzhi) zzia.zza((Object) zzhi, "output");
        this.zza = zzhi2;
        zzhi2.zza = this;
    }
    ...
    public final void zzb(int i, Object obj, zzkb zzkb) throws IOException {
        zzhi zzhi = this.zza;
        zzhi.zza(i, 3);
        zzkb.zza((Object) ((zzjj) obj), (zzlm) zzhi.zza);
        zzhi.zza(i, 4);
    }
    ...
    public final <K, V> void zza(int i, zzja<K, V> zzja, Map<K, V> map) throws IOException {
        for (Map.Entry<K, V> entry : map.entrySet()) {
            this.zza.zza(i, 2);
            this.zza.zzb(zzjb.zza(zzja, entry.getKey(), entry.getValue()));
            zzjb.zza(this.zza, zzja, entry.getKey(), entry.getValue());
        }
    }
}
