...
@DebugMetadata(c = "kotlin.sequences.SequencesKt___SequencesKt$runningFoldIndexed$1", f = "_Sequences.kt", i = {0, 1, 1, 1, 1}, l = {2099, 2104}, m = "invokeSuspend", n = {"$this$sequence", "$this$sequence", FirebaseAnalytics.Param.INDEX, "accumulator", "element"}, s = {"L$0", "L$0", "I$0", "L$1", "L$2"})
