...
public class AHBottomNavigationFABBehavior extends CoordinatorLayout.Behavior<FloatingActionButton> {
    ...
    public boolean layoutDependsOn(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton, View view) {
        ...
        if (view == null || !(view instanceof AHBottomNavigation)) {
            return super.layoutDependsOn(coordinatorLayout, (View) floatingActionButton, view);
        }
        return true;
    }
    ...
    public boolean onDependentViewChanged(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton, View view) {
        ...
        return super.onDependentViewChanged(coordinatorLayout, (View) floatingActionButton, view);
    }
