                    ...
                    if (b >= -32) {
                        if (b >= -16) {
                            if (i7 >= 3) {
                                i6 = i7 - 3;
                                long j6 = j4 + 1;
                                byte zza2 = zzkz.zza(bArr, j4);
                                if (zza2 > -65 || (((b << 28) + (zza2 + 112)) >> 30) != 0) {
                                    break;
                                }
                                long j7 = j6 + 1;
                                if (zzkz.zza(bArr, j6) > -65) {
                                    break;
                                }
                                j4 = j7 + 1;
        ...
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (i < i3) {
                ...
                if (zzla.zzd(zza2)) {
                    ...
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        zzla.zzb(zza2, zzkz.zza(bArr, (long) i6), zzkz.zza(bArr, (long) i8), cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        throw zzij.zzh();
                    ...
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    zzla.zzb(zza2, zzkz.zza(bArr, (long) i6), zzkz.zza(bArr, (long) i9), zzkz.zza(bArr, (long) i10), cArr, i5);
                    i = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzij.zzh();
        ...
        while (true) {
            ...
            if (i4 < length && (charAt = charSequence.charAt(i4)) < 128) {
                ...
                while (i4 < length) {
                    ...
                    if (charAt3 < c2 && j3 < j4) {
                        long j6 = j3 + j5;
                        zzkz.zza(bArr, j3, (byte) charAt3);
                        j2 = j5;
                        j = j6;
                        c = c2;
                    } else if (charAt3 < 2048 && j3 <= j4 - 2) {
                        long j7 = j3 + j5;
                        zzkz.zza(bArr, j3, (byte) ((charAt3 >>> 6) | 960));
                        long j8 = j7 + j5;
                        zzkz.zza(bArr, j7, (byte) ((charAt3 & '?') | 128));
                        c = 128;
                        j = j8;
                        j2 = j5;
                    } else if ((charAt3 < 55296 || 57343 < charAt3) && j3 <= j4 - 3) {
                        long j9 = j3 + j5;
                        zzkz.zza(bArr, j3, (byte) ((charAt3 >>> '\f') | 480));
                        long j10 = j9 + j5;
                        zzkz.zza(bArr, j9, (byte) (((charAt3 >>> 6) & 63) | 128));
                        zzkz.zza(bArr, j10, (byte) ((charAt3 & '?') | 128));
                        j = j10 + 1;
                        j2 = 1;
                        c = 128;
                    } else if (j3 <= j4 - 4) {
                        ...
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt3, charAt4)) {
                                ...
                                long j11 = j3 + 1;
                                zzkz.zza(bArr, j3, (byte) ((codePoint >>> 18) | 240));
                                long j12 = j11 + 1;
                                c = 128;
                                zzkz.zza(bArr, j11, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j13 = j12 + 1;
                                zzkz.zza(bArr, j12, (byte) (((codePoint >>> 6) & 63) | 128));
                                j2 = 1;
                                j = j13 + 1;
                                zzkz.zza(bArr, j13, (byte) ((codePoint & 63) | 128));
                                i4 = i5;
                            } else {
                                i4 = i5;
                            }
