                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m528contentEqualslec5QzE(t.m228unboximpl(), t2.m228unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m524contentEqualsKJPZfPQ(t.m158unboximpl(), t2.m158unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m523contentEqualsFGO6Aew(t.m324unboximpl(), t2.m324unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m526contentEqualskV0jMPg(t.m88unboximpl(), t2.m88unboximpl())) {
                                                        return false;
                                                    }
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                if (t instanceof UByteArray) {
                    T t2 = t;
                    if (t2 != null) {
                        bArr = t2.m88unboximpl();
                    }
                    sb.append(UArraysKt.m540contentToString2csIQuQ(bArr));
                } else if (t instanceof UShortArray) {
                    T t3 = t;
                    if (t3 != null) {
                        sArr = t3.m324unboximpl();
                    }
                    sb.append(UArraysKt.m544contentToStringd6D3K8(sArr));
                } else if (t instanceof UIntArray) {
                    T t4 = t;
                    if (t4 != null) {
                        iArr = t4.m158unboximpl();
                    }
                    sb.append(UArraysKt.m543contentToStringXUkPCBk(iArr));
                } else if (t instanceof ULongArray) {
                    T t5 = t;
                    if (t5 != null) {
                        jArr = t5.m228unboximpl();
                    }
                    sb.append(UArraysKt.m546contentToStringuLth9ew(jArr));
                } else {
