    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i3 == 0) {
            ...
            for (int i6 = 0; i6 < length; i6++) {
                receiveChannelArr3[i6] = CombineKt.asFairChannel(coroutineScope3, this.$flows[Boxing.boxInt(i6).intValue()]);
            }
        ...
        if (intRef2.element == 0) {
            ...
            while (i9 < i) {
                ...
                CombineKt$combineInternal$2$invokeSuspend$$inlined$select$lambda$1 combineKt$combineInternal$2$invokeSuspend$$inlined$select$lambda$1 = new CombineKt$combineInternal$2$invokeSuspend$$inlined$select$lambda$1(i9, null, combineKt$combineInternal$2, i, boolArr, receiveChannelArr, objArr, intRef, intRef2);
                if (booleanValue) {
                    intRef4 = intRef;
                } else {
                    intRef4 = intRef;
                    try {
                        selectBuilderImpl3.invoke(receiveChannel.getOnReceiveOrNull(), new CombineKt$combineInternal$2$invokeSuspend$$inlined$select$lambda$2(combineKt$combineInternal$2$invokeSuspend$$inlined$select$lambda$1, null, i9, combineKt$combineInternal$23, i2, boolArr2, receiveChannelArr2, objArr2, intRef, intRef3));
                    } catch (Throwable th4) {
                        th = th4;
                    }
                }
