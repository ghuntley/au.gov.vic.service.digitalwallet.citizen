...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m1182getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public final long m1204getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1205getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m168constructorimpl(j ^ ULong.m168constructorimpl(j >>> 32))) * 31) + ((int) ULong.m168constructorimpl(j2 ^ ULong.m168constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m205toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m205toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1206fromClosedRange7ftBX0g(long j, long j2, long j3) {
