...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    private final void zaa(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            NotificationManager notificationManager = (NotificationManager) Preconditions.checkNotNull(context.getSystemService(HoldingExpiryPublisher.NOTIFICATION_KEY));
    ...
    public void setDefaultNotificationChannelId(Context context, String str) {
        if (PlatformVersion.isAtLeastO()) {
            Preconditions.checkNotNull(((NotificationManager) Preconditions.checkNotNull(context.getSystemService(HoldingExpiryPublisher.NOTIFICATION_KEY))).getNotificationChannel(str));
        }
        synchronized (zaa) {
            this.zac = str;
        }
