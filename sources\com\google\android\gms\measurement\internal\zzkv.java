...
public final class zzkv extends zzgq {
        ...
        if (zza(obj)) {
            ...
            if (z5) {
                ...
                if (!z3) {
                    ...
                    i = 17;
                    if (!zza("param", str3, ((zzs().zze(str, zzas.zzaq) || !zzd(str2)) && !zzd(str3)) ? 100 : 256, obj)) {
                        return i;
                    }
                    if (!z2) {
                        return 4;
            ...
            if (i2 > 200) {
                zzq().zzj().zza("Parameter array is too long; discarded. Value kind, name, array length", "param", str3, Integer.valueOf(i2));
                z3 = false;
                if (!z3) {
                }
            }
    ...
    public static long zza(long j, long j2) {
        return (j + (j2 * 60000)) / DateFormattingHelper.DAY_IN_MS;
    }
    ...
    public static ArrayList<Bundle> zzb(List<zzz> list) {
        ...
        for (zzz zzz : list) {
            ...
            bundle.putBoolean(AppMeasurementSdk.ConditionalUserProperty.ACTIVE, zzz.zze);
            if (zzz.zzf != null) {
