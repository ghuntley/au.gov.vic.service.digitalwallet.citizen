...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void run() {
        ...
        try {
            ...
            if (delegate$kotlinx_coroutines_core != null) {
                ...
                try {
                    ...
                    if (exceptionalResult$kotlinx_coroutines_core == null && job != null && !job.isActive()) {
                        ...
                        if (DebugKt.getRECOVER_STACK_TRACES()) {
                            if (continuation instanceof CoroutineStackFrame) {
                                ...
                                continuation.resumeWith(Result.m12constructorimpl(ResultKt.createFailure(cancellationException)));
                            }
                        }
                        ...
                        continuation.resumeWith(Result.m12constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                    } else {
                        T successfulResult$kotlinx_coroutines_core = getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core);
                        Result.Companion companion3 = Result.Companion;
                        continuation.resumeWith(Result.m12constructorimpl(successfulResult$kotlinx_coroutines_core));
                    }
                    ...
                    try {
                        ...
                        obj2 = Result.m12constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th2) {
                        Result.Companion companion5 = Result.Companion;
                        obj2 = Result.m12constructorimpl(ResultKt.createFailure(th2));
                    }
                    handleFatalException$kotlinx_coroutines_core(th, Result.m15exceptionOrNullimpl(obj2));
                    return;
                } finally {
            ...
            obj = Result.m12constructorimpl(ResultKt.createFailure(th3));
        }
        handleFatalException$kotlinx_coroutines_core(th, Result.m15exceptionOrNullimpl(obj));
    }
