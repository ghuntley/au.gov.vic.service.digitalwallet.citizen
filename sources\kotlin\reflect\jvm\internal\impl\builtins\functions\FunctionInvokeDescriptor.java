...
public final class FunctionInvokeDescriptor extends SimpleFunctionDescriptorImpl {
    ...
    private final FunctionDescriptor replaceParameterNames(List<Name> list) {
        ...
        Intrinsics.checkNotNullExpressionValue(original2, "newCopyBuilder(TypeSubst…   .setOriginal(original)");
        FunctionDescriptor doSubstitute2 = super.doSubstitute(original2);
        Intrinsics.checkNotNull(doSubstitute2);
        return doSubstitute2;
    }
