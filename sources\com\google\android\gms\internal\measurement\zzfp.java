...
public final class zzfp<K, V> extends zzfc<K, V> {
    ...
    static <K, V> zzfp<K, V> zza(int i, Object[] objArr) {
        byte[] bArr;
        if (i == 0) {
            return (zzfp) zza;
        }
        ...
        int i2 = 0;
        if (i == 1) {
            zzen.zza(objArr[0], objArr[1]);
            return new zzfp<>(null, objArr, 1);
        }
        zzeb.zzb(i, objArr.length >> 1);
        int zza2 = zzfg.zza(i);
        if (i == 1) {
            zzen.zza(objArr[0], objArr[1]);
        } else {
            ...
            if (zza2 <= 128) {
                ...
                while (i2 < i) {
                    ...
                    zzen.zza(obj2, obj3);
                    int zza3 = zzez.zza(obj2.hashCode());
                    while (true) {
                        int i5 = zza3 & i3;
                        int i6 = bArr[i5] & 255;
                        if (i6 == 255) {
                ...
                while (i2 < i) {
                    ...
                    zzen.zza(obj4, obj5);
                    int zza4 = zzez.zza(obj4.hashCode());
                    while (true) {
                        int i8 = zza4 & i3;
                ...
                while (i2 < i) {
                    ...
                    zzen.zza(obj6, obj7);
                    int zza5 = zzez.zza(obj6.hashCode());
                    while (true) {
                        int i11 = zza5 & i3;
                        ?? r8 = bArr[i11];
                        if (r8 == -1) {
