        ...
        private final boolean isPrimitiveCompareTo(FunctionDescriptor functionDescriptor) {
            ...
            if (classDescriptor2 != null) {
                ...
                if (classDescriptor3 != null) {
                    return KotlinBuiltIns.isPrimitiveClass(classDescriptor2) && Intrinsics.areEqual(DescriptorUtilsKt.getFqNameSafe(classDescriptor2), DescriptorUtilsKt.getFqNameSafe(classDescriptor3));
                }
            }
            return false;
        }
