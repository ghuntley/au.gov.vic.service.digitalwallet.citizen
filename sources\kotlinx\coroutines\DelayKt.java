...
public final class DelayKt {
    ...
    public static final Object m1339delayp9JZ4hM(double d, Continuation<? super Unit> continuation) {
        Object delay = delay(m1340toDelayMillisLRDsOJo(d), continuation);
    ...
    public static final long m1340toDelayMillisLRDsOJo(double d) {
        if (Duration.m1280compareToLRDsOJo(d, Duration.Companion.getZERO()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1317toLongMillisecondsimpl(d), 1L);
        }
        return 0;
    }
}
