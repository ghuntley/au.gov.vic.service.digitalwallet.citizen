...
public final class VerifyEmailViewModel$initiateANewSession$2<T> implements Consumer<Throwable> {
    final /* synthetic */ VerifyEmailViewModel this$0;

    VerifyEmailViewModel$initiateANewSession$2(VerifyEmailViewModel verifyEmailViewModel) {
        this.this$0 = verifyEmailViewModel;
    }

    public final void accept(Throwable th) {
        MutableLiveData<ActionEvent<CreateAccountError>> emailResendFailedEvent = this.this$0.getEmailResendFailedEvent();
        CreateAccountError.Companion companion = CreateAccountError.Companion;
        Intrinsics.checkNotNullExpressionValue(th, "it");
        ActionEventKt.postEvent(emailResendFailedEvent, companion.fromThrowable(th, this.this$0.moshi));
