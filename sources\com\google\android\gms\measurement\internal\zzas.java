...
public final class zzas {
    ...
    static {
        Long valueOf = Long.valueOf((long) DateFormattingHelper.DAY_IN_MS);
        ...
        Integer valueOf2 = Integer.valueOf((int) BZip2Constants.baseBlockSize);
        zzj = zza("measurement.upload.max_events_per_day", valueOf2, valueOf2, zzef.zza);
        zzo = zza("measurement.store.max_stored_events_per_app", valueOf2, valueOf2, zzbb.zza);
        zzx = zza("measurement.upload.stale_data_deletion_interval", valueOf, valueOf, zzbl.zza);
        Long valueOf3 = Long.valueOf((long) RemoteConfigKt.ONE_WEEK);
