...
public final class zzge {
    ...
    public static final class zzg extends zzcg<zzg, zza> implements zzdq {
        ...
        static {
            ...
            zzvb = zzcg.zza(zzgc.zzer(), zzg, zzg, null, 66321687, zzfl.MESSAGE, zzg.class);
        }
    ...
    public static final class zzq extends zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            CW_PRIMES(242),
            CW_IOS_PRIMES(699),
            FAMILYLINK_ANDROID_PRIMES(BuildConfig.VERSION_CODE),
            FAMILYLINK_IOS_PRIMES(291),
            WH_PRIMES(248),
            NOVA_ANDROID_PRIMES(249),
            PHOTOS_DRAPER_ANDROID_PRIMES(253),
            GMM_PRIMES(SecretKeyPacket.USAGE_SHA1),
            ...
            UNICORN_FAMILY_MANAGEMENT(Opcodes.IRETURN),
            ...
            DRIVE_VIEWER(Opcodes.ANEWARRAY),
            PDF_VIEWER(Opcodes.ARRAYLENGTH),
            ...
            CLEARCUT_TEST(654),
            ASSISTANTLITE(655),
            ASSISTANTLITE_ANDROID_PRIMES(JSONParser.MODE_RFC4627),
            MUSK(657),
            TV_LAUNCHER(658),
            FOOD_ORDERING(659),
            TALKBACK(660),
            ...
            public static zzb zzax(int i) {
                switch (i) {
                    ...
                    case Opcodes.MULTIANEWARRAY /*{ENCODED_INT: 197}*/:
                        return MOB_DOG;
                    case Opcodes.IFNULL /*{ENCODED_INT: 198}*/:
                        return WALLET_APP;
                    case Opcodes.IFNONNULL /*{ENCODED_INT: 199}*/:
                        return GBOARD;
                    case 200:
                    ...
                    case 243:
                        return CW_COUNTERS;
                    case BuildConfig.VERSION_CODE /*{ENCODED_INT: 244}*/:
