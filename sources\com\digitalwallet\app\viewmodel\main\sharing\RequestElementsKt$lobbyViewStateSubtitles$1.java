...
final class RequestElementsKt$lobbyViewStateSubtitles$1 extends Lambda implements Function1<LobbyViewState, Integer> {
    public static final RequestElementsKt$lobbyViewStateSubtitles$1 INSTANCE = new RequestElementsKt$lobbyViewStateSubtitles$1();

    RequestElementsKt$lobbyViewStateSubtitles$1() {
        super(1);
    }

    public final int invoke(LobbyViewState lobbyViewState) {
        Intrinsics.checkNotNullParameter(lobbyViewState, "it");
        return R.string.request_searching_subtitle;
    }
