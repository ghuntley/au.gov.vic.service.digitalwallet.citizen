...
public final class zzeg {
    ...
    private static void zza(zzef zzef, StringBuilder sb, int i) {
        boolean z;
        HashMap hashMap = new HashMap();
        HashMap hashMap2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet();
        Method[] declaredMethods = zzef.getClass().getDeclaredMethods();
        ...
        for (String str : treeSet) {
            ...
            if (replaceFirst.endsWith("List") && !replaceFirst.endsWith("OrBuilderList") && !replaceFirst.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zza(sb, i, zzh(concat), zzcx.zza(method2, zzef, new Object[0]));
                }
            }
            if (replaceFirst.endsWith("Map") && !replaceFirst.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zza(sb, i, zzh(concat2), zzcx.zza(method3, zzef, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object zza = zzcx.zza(method4, zzef, new Object[0]);
                    if (method5 == null) {
                                ...
                                if (!(zza instanceof Float)) {
                                    if (!(zza instanceof Double)) {
                                        if (zza instanceof String) {
                                            z = zza.equals("");
                                        } else if (zza instanceof zzbp) {
                                            z = zza.equals(zzbp.zzakv);
                                        } else {
                                            z = !(zza instanceof zzef) ? false : false;
                                        }
                                        if (z) {
                                            z2 = false;
                                        }
                        ...
                        z2 = ((Boolean) zzcx.zza(method5, zzef, new Object[0])).booleanValue();
                    }
                    if (z2) {
                        zza(sb, i, zzh(concat3), zza);
                    }
                }
            }
        }
        if (zzef instanceof zzcx.zzb) {
            Iterator<Map.Entry<Object, Object>> it = ((zzcx.zzb) zzef).zzapf.iterator();
            if (it.hasNext()) {
                it.next().getKey();
