...
public final class CheckInRepository$clearCheckInUserDetail$1 extends Lambda implements Function1<CheckInCookie, Unit> {
    public static final CheckInRepository$clearCheckInUserDetail$1 INSTANCE = new CheckInRepository$clearCheckInUserDetail$1();

    CheckInRepository$clearCheckInUserDetail$1() {
        super(1);
    }
    ...
    public final void invoke(CheckInCookie checkInCookie) {
        ...
        String str = null;
        checkInCookie.setCheckInFirstName(str);
        checkInCookie.setCheckInLastName(str);
        checkInCookie.setCheckInPhoneNumber(str);
    }
}
