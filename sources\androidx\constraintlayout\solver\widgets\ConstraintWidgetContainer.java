...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    public void layout() {
        ...
        if (Optimizer.enabled(this.mOptimizationLevel, 1)) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                if (constraintWidget.isMeasureRequested() && !(constraintWidget instanceof Guideline) && !(constraintWidget instanceof Barrier) && !(constraintWidget instanceof VirtualLayout) && !constraintWidget.isInVirtualLayout()) {
                    if (((constraintWidget.getDimensionBehaviour(0) != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || constraintWidget.mMatchConstraintDefaultWidth == 1 || constraintWidget.getDimensionBehaviour(1) != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || constraintWidget.mMatchConstraintDefaultHeight == 1) ? null : 1) == null) {
        ...
        Object[] objArr2 = (getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT || getVerticalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) ? 1 : null;
        resetChains();
        for (int i5 = 0; i5 < size; i5++) {
        ...
        while (z4) {
            ...
            if (objArr2 == null || i7 >= 8 || !Optimizer.flags[2]) {
                z2 = false;
            } else {
                int i10 = 0;
                int i11 = 0;
            ...
            if (!z3) {
                ...
                char c2 = r6 == true ? 1 : 0;
                char c3 = r6 == true ? 1 : 0;
                if (dimensionBehaviourArr[c] == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT && i > 0 && getHeight() > i) {
