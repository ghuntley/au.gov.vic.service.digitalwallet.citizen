...
import com.digitalwallet.app.databinding.NicknameCreateBinding;
...
public final class NicknameCreateFragment extends BaseAppFragment<NicknameCreateBinding> implements NicknameView {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        ((NicknameCreateBinding) getBinding()).nickname.setOnEditorActionListener(new NicknameCreateFragment$onViewCreated$1(this));
        SpecialURLs.Companion companion = SpecialURLs.Companion;
        Context requireContext = requireContext();
        Intrinsics.checkNotNullExpressionValue(requireContext, "requireContext()");
        TextView textView = ((NicknameCreateBinding) getBinding()).vLoginPrivacy;
        Intrinsics.checkNotNullExpressionValue(textView, "binding.vLoginPrivacy");
        SpecialURLs.Companion.setPrivacySecurityText$default(companion, requireContext, R.string.login_privacy, textView, ContextCompat.getColor(requireContext(), R.color.dw_orange_RES_2114060292), null, 16, null);
    }
    ...
    @Override // com.digitalwallet.app.viewmodel.main.NicknameView
    public void done() {
        this.doneMute.tryDo(new NicknameCreateFragment$done$1(this));
    }
}
