...
public abstract class TimeMark {
    ...
    public abstract double m1331elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1333plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this, d, null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1332minusLRDsOJo(double d) {
        return m1333plusLRDsOJo(Duration.m1322unaryMinusUwyO8pc(d));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1302isNegativeimpl(m1331elapsedNowUwyO8pc());
    }
