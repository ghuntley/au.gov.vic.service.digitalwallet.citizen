...
public class PKCS12Example {
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        KeyFactory instance = KeyFactory.getInstance("RSA", "BC");
        ...
        PrivateKey generatePrivate3 = instance.generatePrivate(rSAPrivateCrtKeySpec);
        PublicKey generatePublic3 = instance.generatePublic(rSAPublicKeySpec);
        Certificate[] certificateArr = new Certificate[3];
        certificateArr[2] = createMasterCert(generatePublic, generatePrivate);
        certificateArr[1] = createIntermediateCert(generatePublic2, generatePrivate, (X509Certificate) certificateArr[2]);
        certificateArr[0] = createCert(generatePublic3, generatePrivate2, generatePublic2);
        ...
        KeyStore instance2 = KeyStore.getInstance("PKCS12", "BC");
