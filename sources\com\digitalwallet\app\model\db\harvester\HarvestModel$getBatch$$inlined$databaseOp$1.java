...
public final class HarvestModel$getBatch$$inlined$databaseOp$1<T> implements SingleOnSubscribe<T> {
    final /* synthetic */ long $id$inlined;
    final /* synthetic */ HarvestModel this$0;

    public HarvestModel$getBatch$$inlined$databaseOp$1(HarvestModel harvestModel, long j) {
    ...
    public final void subscribe(final SingleEmitter<T> singleEmitter) {
        ...
        new AsyncTask<Void, Void, Void>(this) {
            /* class com.digitalwallet.app.model.db.harvester.HarvestModel$getBatch$$inlined$databaseOp$1.AnonymousClass1 */
            final /* synthetic */ HarvestModel$getBatch$$inlined$databaseOp$1 this$0;
            ...
            public Void doInBackground(Void... voidArr) {
                ...
                try {
                    singleEmitter.onSuccess(this.this$0.this$0.database.harvestTagBatchDao().getById(this.this$0.$id$inlined));
                    return null;
                } catch (Throwable th) {
