        ...
        if (continuation instanceof TickerChannelsKt$fixedPeriodTicker$1) {
            ...
            if ((tickerChannelsKt$fixedPeriodTicker$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    coerceAtLeast = RangesKt.coerceAtLeast(j9 - r15, 0L);
                    if (coerceAtLeast == 0) {
                    }
                    ...
                    tickerChannelsKt$fixedPeriodTicker$1.J$4 = r15;
                    ...
                    long nanoTime2 = (timeSource22 != null || (boxLong = Boxing.boxLong(timeSource22.nanoTime())) == null) ? System.nanoTime() : boxLong.longValue();
