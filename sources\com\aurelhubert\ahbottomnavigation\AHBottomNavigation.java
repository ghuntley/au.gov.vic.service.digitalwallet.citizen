            ...
            if (f2 != 0.0f) {
                ...
                if (f3 != 0.0f) {
                    ...
                    while (i < this.items.size()) {
                        boolean z3 = this.currentItem == i ? true : z2;
                        ...
                        if (this.itemsEnabledStates[i].booleanValue()) {
                            ...
                            imageView.setImageDrawable(AHHelper.getTintDrawable(this.items.get(i).getDrawable(this.context), this.itemDisableColor, this.forceTint));
            ...
            if (f != 0.0f) {
                ...
                if (f2 != 0.0f) {
                    ...
                    while (i2 < this.views.size()) {
                        ...
                        if (this.selectedBackgroundVisible) {
                            view.setSelected(i2 == i ? z2 : false);
                        }
                        if (i2 == i) {
