...
public final class HarvestModel$deleteBatch$$inlined$backgroundSerial$1 extends AsyncTask<Void, Void, Void> {
    final /* synthetic */ SavedHarvestBatch $batch$inlined;
    final /* synthetic */ HarvestModel this$0;

    public HarvestModel$deleteBatch$$inlined$backgroundSerial$1(HarvestModel harvestModel, SavedHarvestBatch savedHarvestBatch) {
        this.this$0 = harvestModel;
        this.$batch$inlined = savedHarvestBatch;
    }

    /* access modifiers changed from: protected */
    public Void doInBackground(Void... voidArr) {
        Intrinsics.checkNotNullParameter(voidArr, "params");
        this.this$0.database.harvestTagBatchDao().delete(this.$batch$inlined);
        return null;
    }
}
