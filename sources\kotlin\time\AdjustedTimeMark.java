...
public final class AdjustedTimeMark extends TimeMark {
    ...
    public final double m1275getAdjustmentUwyO8pc() {
    ...
    public double m1274elapsedNowUwyO8pc() {
        return Duration.m1304minusLRDsOJo(this.mark.m1331elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1276plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m1305plusLRDsOJo(this.adjustment, d), null);
    }
}
