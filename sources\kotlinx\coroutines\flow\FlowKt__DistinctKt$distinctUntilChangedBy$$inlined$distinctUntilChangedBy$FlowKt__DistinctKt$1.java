...
public final class FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$distinctUntilChangedBy$FlowKt__DistinctKt$1 implements Flow<T> {
    ...
    public Object collect(final FlowCollector flowCollector, Continuation continuation) {
        ...
        Object collect = this.$this_distinctUntilChangedBy$inlined.collect(new FlowCollector<T>() {
            /* class kotlinx.coroutines.flow.FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$distinctUntilChangedBy$FlowKt__DistinctKt$1.AnonymousClass2 */
            ...
            public Object emit(Object obj, Continuation continuation) {
                ...
                if (continuation instanceof AnonymousClass1) {
                    ...
                    if ((r0.label & Integer.MIN_VALUE) != 0) {
                        ...
                        if (i != 0) {
                            ...
                            T t = (T) this.$keySelector$inlined.invoke(obj);
                            if (objectRef.element == NullSurrogateKt.NULL || !Boxing.boxBoolean(Intrinsics.areEqual((Object) objectRef.element, (Object) t)).booleanValue()) {
                                objectRef.element = t;
                ...
                r0 = new ContinuationImpl(this, continuation) {
                    /* class kotlinx.coroutines.flow.FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$distinctUntilChangedBy$FlowKt__DistinctKt$1.AnonymousClass2.AnonymousClass1 */
                    Object L$0;
                    Object L$1;
                    Object L$2;
                    Object L$3;
