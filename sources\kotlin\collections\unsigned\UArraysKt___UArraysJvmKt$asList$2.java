...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m467containsVKZWuLQ(((ULong) obj).m211unboximpl());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ ULong get(int i) {
        return ULong.m162boximpl(m468getsVKNKU(i));
    }

    @Override // kotlin.collections.AbstractList
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof ULong) {
            return m469indexOfVKZWuLQ(((ULong) obj).m211unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof ULong) {
            return m470lastIndexOfVKZWuLQ(((ULong) obj).m211unboximpl());
        }
        return -1;
    }
    ...
    public int getSize() {
        return ULongArray.m220getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection
    public boolean isEmpty() {
        return ULongArray.m222isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m467containsVKZWuLQ(long j) {
        return ULongArray.m215containsVKZWuLQ(this.$this_asList, j);
    }

    /* renamed from: get-s-VKNKU  reason: not valid java name */
    public long m468getsVKNKU(int i) {
        return ULongArray.m219getsVKNKU(this.$this_asList, i);
    }

    /* renamed from: indexOf-VKZWuLQ  reason: not valid java name */
    public int m469indexOfVKZWuLQ(long j) {
        return ArraysKt.indexOf(this.$this_asList, j);
    }

    /* renamed from: lastIndexOf-VKZWuLQ  reason: not valid java name */
    public int m470lastIndexOfVKZWuLQ(long j) {
