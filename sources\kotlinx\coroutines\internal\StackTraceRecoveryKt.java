...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            str = Result.m12constructorimpl(Class.forName(str4).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            str = Result.m12constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m15exceptionOrNullimpl(str) == null) {
            str4 = str;
        }
        baseContinuationImplClassName = str4;
        try {
            Result.Companion companion3 = Result.Companion;
            str2 = Result.m12constructorimpl(Class.forName(str3).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            str2 = Result.m12constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m15exceptionOrNullimpl(str2) == null) {
            str3 = str2;
        }
