...
public class X509CRLHolder {
    ...
    private static CertificateList parseBytes(byte[] bArr) throws IOException {
        try {
            return CertificateList.getInstance(ASN1Object.fromByteArray(bArr));
    ...
    public Collection getRevokedCertificates() {
        ...
        Enumeration revokedCertificateEnumeration = this.x509CRL.getRevokedCertificateEnumeration();
        while (revokedCertificateEnumeration.hasMoreElements()) {
            arrayList.add(new X509CRLEntryHolder((TBSCertList.CRLEntry) revokedCertificateEnumeration.nextElement()));
        }
        return arrayList;
    }
