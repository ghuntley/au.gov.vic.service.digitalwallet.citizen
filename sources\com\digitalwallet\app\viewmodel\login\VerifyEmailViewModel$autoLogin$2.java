...
public final class VerifyEmailViewModel$autoLogin$2 implements Action {
    final /* synthetic */ VerifyEmailViewModel this$0;

    VerifyEmailViewModel$autoLogin$2(VerifyEmailViewModel verifyEmailViewModel) {
        this.this$0 = verifyEmailViewModel;
    }

    @Override // io.reactivex.functions.Action
    public final void run() {
        ActionEventKt.post(this.this$0.getVerificationPassedEvent());
