...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public final Object receiveOrClosed(Continuation<? super ValueOrClosed<? extends E>> continuation) {
        ...
        if (pollInternal instanceof Closed) {
            ...
            obj = ValueOrClosed.m1344constructorimpl(new ValueOrClosed.Closed(((Closed) pollInternal).closeCause));
        } else {
            ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
            obj = ValueOrClosed.m1344constructorimpl(pollInternal);
        }
        return ValueOrClosed.m1343boximpl(obj);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        if (closedForSend != null) {
            Object r0 = InlineList.m1362constructorimpl$default(null, 1, null);
            while (true) {
                ...
                if (prevNode instanceof LockFreeLinkedListHead) {
                    ...
                    r0 = InlineList.m1367plusimpl(r0, (Send) prevNode);
                } else {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (z) {
            if (i == 0) {
                ...
                ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m1343boximpl(ValueOrClosed.m1344constructorimpl(new ValueOrClosed.Closed(((Closed) obj).closeCause))), selectInstance.getCompletion());
            }
        } else if (i == 2) {
            ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
            if (z) {
                obj2 = ValueOrClosed.m1344constructorimpl(new ValueOrClosed.Closed(((Closed) obj).closeCause));
            } else {
                obj2 = ValueOrClosed.m1344constructorimpl(obj);
            }
            UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m1343boximpl(obj2), selectInstance.getCompletion());
        } else {
                ...
                if (!getChannel().enqueueReceive(receiveHasNext2)) {
                    ...
                    if (!(pollInternal instanceof Closed)) {
                        if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                            ...
                            cancellableContinuationImpl.resumeWith(Result.m12constructorimpl(boxBoolean));
                            break;
                        }
                    } else {
                        ...
                        if (closed.closeCause == null) {
                            ...
                            cancellableContinuationImpl.resumeWith(Result.m12constructorimpl(boxBoolean2));
                        } else {
                            Throwable receiveException = closed.getReceiveException();
                            Result.Companion companion3 = Result.Companion;
                            cancellableContinuationImpl.resumeWith(Result.m12constructorimpl(ResultKt.createFailure(receiveException)));
                        }
                    }
                } else {
    ...
    public static final class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            ...
            ValueOrClosed.Companion companion = ValueOrClosed.Companion;
            return ValueOrClosed.m1343boximpl(ValueOrClosed.m1344constructorimpl(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1 && closed.closeCause == null) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m12constructorimpl(null));
            } else if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
                ValueOrClosed r3 = ValueOrClosed.m1343boximpl(ValueOrClosed.m1344constructorimpl(new ValueOrClosed.Closed(closed.closeCause)));
                Result.Companion companion3 = Result.Companion;
                this.cont.resumeWith(Result.m12constructorimpl(r3));
            } else {
                Throwable receiveException = closed.getReceiveException();
                Result.Companion companion4 = Result.Companion;
                this.cont.resumeWith(Result.m12constructorimpl(ResultKt.createFailure(receiveException)));
            }
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E e) {
            ...
            if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                e = (E) ValueOrClosed.m1343boximpl(ValueOrClosed.m1344constructorimpl(e));
            }
            ...
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    if (i == 2) {
                        Function2<Object, Continuation<? super R>, Object> function2 = this.block;
                        ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                        ContinuationKt.startCoroutine(function2, ValueOrClosed.m1343boximpl(ValueOrClosed.m1344constructorimpl(new ValueOrClosed.Closed(closed.closeCause))), this.select.getCompletion());
                    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: kotlinx.coroutines.channels.AbstractChannel$ReceiveElement */
    /* JADX WARN: Multi-variable type inference failed */
    /* access modifiers changed from: package-private */
                ...
                if (!enqueueReceive(receiveElement2)) {
                    ...
                    if (!(pollInternal instanceof Closed)) {
                        if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                            ...
                            Result.Companion companion = Result.Companion;
                            cancellableContinuationImpl.resumeWith(Result.m12constructorimpl(resumeValue));
                            break;
                        }
                    } else {
