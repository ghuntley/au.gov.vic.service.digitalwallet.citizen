...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        for (UByte uByte : collection) {
            UByteArray.m84setVurrAj0(r0, i, uByte.m71unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        ...
        int[] r0 = UIntArray.m143constructorimpl(collection.size());
        int i = 0;
        for (UInt uInt : collection) {
            UIntArray.m154setVXSXFK8(r0, i, uInt.m141unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        ...
        long[] r0 = ULongArray.m213constructorimpl(collection.size());
        int i = 0;
        for (ULong uLong : collection) {
            ULongArray.m224setk8EXiF4(r0, i, uLong.m211unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        ...
        short[] r0 = UShortArray.m309constructorimpl(collection.size());
        int i = 0;
        for (UShort uShort : collection) {
            UShortArray.m320set01HTLdE(r0, i, uShort.m307unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt uInt : iterable) {
            i = UInt.m98constructorimpl(i + uInt.m141unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong uLong : iterable) {
            j = ULong.m168constructorimpl(j + uLong.m211unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte uByte : iterable) {
            i = UInt.m98constructorimpl(i + UInt.m98constructorimpl(uByte.m71unboximpl() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort uShort : iterable) {
            i = UInt.m98constructorimpl(i + UInt.m98constructorimpl(uShort.m307unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
