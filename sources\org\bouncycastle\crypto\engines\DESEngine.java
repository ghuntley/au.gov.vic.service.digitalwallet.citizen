...
public class DESEngine implements BlockCipher {
    ...
    public void desFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i6 = i4 ^ i5;
        int i7 = i3 ^ (i5 << 4);
        int i8 = ((i7 >>> 16) ^ i6) & SupportMenu.USER_MASK;
        int i9 = i6 ^ i8;
        int i10 = i7 ^ (i8 << 16);
        ...
        int i45 = i42 ^ i44;
        int i46 = i43 ^ (i44 << 2);
        int i47 = ((i45 >>> 16) ^ i46) & SupportMenu.USER_MASK;
        int i48 = i46 ^ i47;
        int i49 = i45 ^ (i47 << 16);
