...
public final class CheckInSummaryFragment$observeEvents$2 extends Lambda implements Function1<PrimaryPersonCheckIn, Unit> {
    final /* synthetic */ CheckInSummaryFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CheckInSummaryFragment$observeEvents$2(CheckInSummaryFragment checkInSummaryFragment) {
        super(1);
    ...
    public final void invoke(PrimaryPersonCheckIn primaryPersonCheckIn) {
        ...
        CheckInEditPersonInputFragment createFragment = CheckInEditPersonInputFragment.Companion.createFragment(primaryPersonCheckIn);
