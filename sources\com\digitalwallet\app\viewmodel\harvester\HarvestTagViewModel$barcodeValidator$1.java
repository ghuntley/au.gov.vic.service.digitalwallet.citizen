...
public final class HarvestTagViewModel$barcodeValidator$1 extends Lambda implements Function1<Barcode, Boolean> {
    final /* synthetic */ HarvestTagViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HarvestTagViewModel$barcodeValidator$1(HarvestTagViewModel harvestTagViewModel) {
        super(1);
    ...
    public final boolean invoke(Barcode barcode) {
        ...
        HarvestTagViewModel harvestTagViewModel = this.this$0;
        String str = barcode.rawValue;
        Intrinsics.checkNotNullExpressionValue(str, "barcode.rawValue");
        Long l = harvestTagViewModel.convertBarcode(str);
        if (l == null) {
            return false;
        }
        this.this$0.addBarcode(l.longValue());
        return false;
    }
}
