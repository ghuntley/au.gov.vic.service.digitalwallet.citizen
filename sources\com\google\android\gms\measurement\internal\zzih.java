                ...
                if (zzb2 == null) {
                    ...
                    try {
                        ...
                        if (zzkw == null || zzkw.zze == null) {
                            zzkw zzkw2 = new zzkw(zzc2, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_lte", zzl().currentTimeMillis(), 0L);
                            zza6.add(zzkw2);
                            zzi().zza(zzkw2);
                        }
                        zzkr f_ = f_();
                        ...
                        if (f_.zzk().zzi()) {
                            ...
                            if (zzb2.zzaf() && f_.zzj().zze(zzc3)) {
                                ...
                                zza6.add(new zzkw(zzc3, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_npa", f_.zzl().currentTimeMillis(), 1L));
                            }
                        }
                        ...
                        zzf.zzv();
                        zzcd.zzg.zza zza11 = zza2.zzg((int) zzf.zzs()).zzg(33025L).zza(zzl().currentTimeMillis());
