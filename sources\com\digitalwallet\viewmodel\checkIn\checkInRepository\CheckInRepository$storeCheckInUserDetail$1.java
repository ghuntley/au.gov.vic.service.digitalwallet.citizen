...
public final class CheckInRepository$storeCheckInUserDetail$1 extends Lambda implements Function1<CheckInCookie, Unit> {
    final /* synthetic */ CheckIn $checkInItem;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CheckInRepository$storeCheckInUserDetail$1(CheckIn checkIn) {
        super(1);
    ...
    public final void invoke(CheckInCookie checkInCookie) {
        ...
        checkInCookie.setCheckInFirstName(this.$checkInItem.getFirstName());
        checkInCookie.setCheckInLastName(this.$checkInItem.getLastName());
        checkInCookie.setCheckInPhoneNumber(this.$checkInItem.getPhoneNumber());
    }
}
