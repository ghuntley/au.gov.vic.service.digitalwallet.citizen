                    ...
                    if (b >= -32) {
                        if (b >= -16) {
                            if (i7 >= 3) {
                                i6 = i7 - 3;
                                long j6 = j4 + 1;
                                byte zza2 = zztx.zza(bArr, j4);
                                if (zza2 > -65 || (((b << 28) + (zza2 + 112)) >> 30) != 0) {
                                    break;
                                }
                                long j7 = j6 + 1;
                                if (zztx.zza(bArr, j6) > -65) {
                                    break;
                                }
                                j4 = j7 + 1;
                                if (zztx.zza(bArr, j7) > -65) {
                                    break;
                                }
                            } else {
                            ...
                            i6 = i7 - 2;
                            long j8 = j4 + 1;
                            byte zza3 = zztx.zza(bArr, j4);
                            if (zza3 > -65 || ((b == -32 && zza3 < -96) || (b == -19 && zza3 >= -96))) {
                                break;
                            }
                            j4 = j8 + 1;
                            if (zztx.zza(bArr, j8) > -65) {
                                break;
                            }
                        } else {
                            return zza(bArr, b, j4, i7);
            ...
            while (i < i3) {
                ...
                if (zzua.zzh(zza2)) {
                    ...
                    while (i6 < i3) {
                        ...
                        i6++;
                        zzua.zzb(zza3, cArr, i7);
                        i7++;
                    }
                    i = i6;
                    i5 = i7;
                } else if (zzua.zzi(zza2)) {
                    if (i6 < i3) {
                        zzua.zzb(zza2, zztx.zza(bArr, (long) i6), cArr, i5);
                        i = i6 + 1;
                        i5++;
                    } else {
                        throw zzrk.zzpw();
                    }
                } else if (zzua.zzj(zza2)) {
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        zzua.zzb(zza2, zztx.zza(bArr, (long) i6), zztx.zza(bArr, (long) i8), cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        throw zzrk.zzpw();
                    ...
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    zzua.zzb(zza2, zztx.zza(bArr, (long) i6), zztx.zza(bArr, (long) i9), zztx.zza(bArr, (long) i10), cArr, i5);
                    i = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzrk.zzpw();
            ...
            if (i4 < length && (charAt = charSequence.charAt(i4)) < 128) {
                ...
                while (i4 < length) {
                    ...
                    if (charAt3 < c2 && j3 < j4) {
                        ...
                        long j8 = j7 + j5;
                        zztx.zza(bArr, j7, (byte) ((charAt3 & '?') | 128));
                        c = 128;
                        j = j8;
                        j2 = j5;
                    } else if ((charAt3 < 55296 || 57343 < charAt3) && j3 <= j4 - 3) {
                        long j9 = j3 + j5;
                        zztx.zza(bArr, j3, (byte) ((charAt3 >>> '\f') | 480));
                        long j10 = j9 + j5;
                        zztx.zza(bArr, j9, (byte) (((charAt3 >>> 6) & 63) | 128));
                        zztx.zza(bArr, j10, (byte) ((charAt3 & '?') | 128));
                        j = j10 + 1;
                        j2 = 1;
                        c = 128;
                    } else if (j3 <= j4 - 4) {
                        ...
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt3, charAt4)) {
                                ...
                                long j12 = j11 + 1;
                                c = 128;
                                zztx.zza(bArr, j11, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j13 = j12 + 1;
                                zztx.zza(bArr, j12, (byte) (((codePoint >>> 6) & 63) | 128));
                                j2 = 1;
                                j = j13 + 1;
                                zztx.zza(bArr, j13, (byte) ((codePoint & 63) | 128));
                                i4 = i5;
                            } else {
                                i4 = i5;
                            }
