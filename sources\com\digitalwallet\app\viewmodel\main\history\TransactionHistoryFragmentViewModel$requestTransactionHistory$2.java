...
public final class TransactionHistoryFragmentViewModel$requestTransactionHistory$2<T, R> implements Function<TransactionHistory, List<? extends TransactionHistoryItem>> {
    public static final TransactionHistoryFragmentViewModel$requestTransactionHistory$2 INSTANCE = new TransactionHistoryFragmentViewModel$requestTransactionHistory$2();

    TransactionHistoryFragmentViewModel$requestTransactionHistory$2() {
    }
