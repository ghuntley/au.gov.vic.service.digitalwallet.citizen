        ...
        while (true) {
            ...
            if (i4 < length && (charAt = charSequence.charAt(i4)) < 128) {
                ...
                while (i4 < length) {
                    ...
                    if (charAt3 < c2 && j3 < j4) {
                        long j6 = j3 + j5;
                        zzma.zza(bArr, j3, (byte) charAt3);
                        j2 = j5;
                        j = j6;
                        c = c2;
                    } else if (charAt3 < 2048 && j3 <= j4 - 2) {
                        long j7 = j3 + j5;
                        zzma.zza(bArr, j3, (byte) ((charAt3 >>> 6) | 960));
                        long j8 = j7 + j5;
                        ...
                        long j9 = j3 + j5;
                        zzma.zza(bArr, j3, (byte) ((charAt3 >>> '\f') | 480));
                        long j10 = j9 + j5;
                        zzma.zza(bArr, j9, (byte) (((charAt3 >>> 6) & 63) | 128));
                        zzma.zza(bArr, j10, (byte) ((charAt3 & '?') | 128));
                        j = j10 + 1;
                        j2 = 1;
                        c = 128;
                    } else if (j3 <= j4 - 4) {
                        ...
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt3, charAt4)) {
                                ...
                                long j12 = j11 + 1;
                                c = 128;
                                zzma.zza(bArr, j11, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j13 = j12 + 1;
                                zzma.zza(bArr, j12, (byte) (((codePoint >>> 6) & 63) | 128));
                                j2 = 1;
                                j = j13 + 1;
                                zzma.zza(bArr, j13, (byte) ((codePoint & 63) | 128));
                                i4 = i5;
                            } else {
                                i4 = i5;
                            }
