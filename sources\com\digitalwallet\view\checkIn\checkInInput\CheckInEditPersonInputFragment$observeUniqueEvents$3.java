...
public final class CheckInEditPersonInputFragment$observeUniqueEvents$3 extends Lambda implements Function1<DependantCheckIn, Unit> {
    ...
    CheckInEditPersonInputFragment$observeUniqueEvents$3(CheckInEditPersonInputFragment checkInEditPersonInputFragment, CheckInSummaryFragment checkInSummaryFragment) {
        super(1);
    ...
    public final void invoke(DependantCheckIn dependantCheckIn) {
        ...
        if (!(checkInSummaryFragment == null || (viewModel = checkInSummaryFragment.getViewModel()) == null)) {
            viewModel.editADependant(dependantCheckIn);
        }
        this.this$0.goBack();
    }
}
