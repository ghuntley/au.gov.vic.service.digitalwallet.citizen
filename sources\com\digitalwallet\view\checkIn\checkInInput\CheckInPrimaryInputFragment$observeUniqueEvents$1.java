...
public final class CheckInPrimaryInputFragment$observeUniqueEvents$1 extends Lambda implements Function1<PrimaryPersonCheckIn, Unit> {
    final /* synthetic */ CheckInPrimaryInputFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CheckInPrimaryInputFragment$observeUniqueEvents$1(CheckInPrimaryInputFragment checkInPrimaryInputFragment) {
        super(1);
    ...
    public final void invoke(PrimaryPersonCheckIn primaryPersonCheckIn) {
        ...
        CheckInAddDependantInputFragment createFragment = CheckInAddDependantInputFragment.Companion.createFragment(primaryPersonCheckIn, true);
        ...
        beginTransaction.replace(containerId, createFragment, Reflection.getOrCreateKotlinClass(CheckInAddDependantInputFragment.class).getSimpleName()).addToBackStack(null).commit();
    }
}
