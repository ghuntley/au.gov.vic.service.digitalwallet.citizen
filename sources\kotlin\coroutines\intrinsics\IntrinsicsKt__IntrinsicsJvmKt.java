...
public class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    private static final <T> Continuation<Unit> createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt(Continuation<? super T> continuation, Function1<? super Continuation<? super T>, ? extends Object> function1) {
        ...
        if (context == EmptyCoroutineContext.INSTANCE) {
            ...
            intrinsicsKt__IntrinsicsJvmKt$createCoroutineFromSuspendFunction$2 = new IntrinsicsKt__IntrinsicsJvmKt$createCoroutineFromSuspendFunction$1(function1, continuation, continuation);
        } else {
            Objects.requireNonNull(continuation, "null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
            intrinsicsKt__IntrinsicsJvmKt$createCoroutineFromSuspendFunction$2 = new IntrinsicsKt__IntrinsicsJvmKt$createCoroutineFromSuspendFunction$2(function1, continuation, context, continuation, context);
        }
