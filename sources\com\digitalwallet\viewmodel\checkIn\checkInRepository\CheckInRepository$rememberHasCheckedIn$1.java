...
public final class CheckInRepository$rememberHasCheckedIn$1 extends Lambda implements Function1<CheckInCookie, Unit> {
    public static final CheckInRepository$rememberHasCheckedIn$1 INSTANCE = new CheckInRepository$rememberHasCheckedIn$1();

    CheckInRepository$rememberHasCheckedIn$1() {
        super(1);
    }
    ...
    public final void invoke(CheckInCookie checkInCookie) {
        ...
        checkInCookie.setCheckInAtLeastOnce(true);
    }
}
