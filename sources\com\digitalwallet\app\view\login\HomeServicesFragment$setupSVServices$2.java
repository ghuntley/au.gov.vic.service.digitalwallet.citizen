...
public final class HomeServicesFragment$setupSVServices$2 extends Lambda implements Function1<SVItem, Unit> {
    final /* synthetic */ HomeServicesFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HomeServicesFragment$setupSVServices$2(HomeServicesFragment homeServicesFragment) {
        super(1);
    ...
    public final void invoke(SVItem sVItem) {
        ...
        this.this$0.openURL(sVItem.getUrl(), sVItem.getId());
    }
}
