...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1334copyRFiDyg4$default(TimedValue timedValue, Object obj, double d, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1336copyRFiDyg4(obj, d);
    }
    ...
    public final double m1335component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1336copyRFiDyg4(T t, double d) {
    ...
    public String toString() {
        return "TimedValue(value=" + ((Object) this.value) + ", duration=" + Duration.m1319toStringimpl(this.duration) + ")";
    }
    ...
    public final double m1337getDurationUwyO8pc() {
        return this.duration;
    }
