...
public class NotificationTarget extends SimpleTarget<Bitmap> {
    ...
    private void update() {
        ((NotificationManager) Preconditions.checkNotNull((NotificationManager) this.context.getSystemService(HoldingExpiryPublisher.NOTIFICATION_KEY))).notify(this.notificationTag, this.notificationId, this.notification);
    }
