...
public class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        instance.calculateTwilight(currentTimeMillis - DateFormattingHelper.DAY_IN_MS, location.getLatitude(), location.getLongitude());
        ...
        instance.calculateTwilight(DateFormattingHelper.DAY_IN_MS + currentTimeMillis, location.getLatitude(), location.getLongitude());
