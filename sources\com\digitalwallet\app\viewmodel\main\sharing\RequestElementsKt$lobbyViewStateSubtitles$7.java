...
final class RequestElementsKt$lobbyViewStateSubtitles$7 extends Lambda implements Function1<LobbyViewState, Integer> {
    public static final RequestElementsKt$lobbyViewStateSubtitles$7 INSTANCE = new RequestElementsKt$lobbyViewStateSubtitles$7();

    RequestElementsKt$lobbyViewStateSubtitles$7() {
        super(1);
    }

    public final int invoke(LobbyViewState lobbyViewState) {
        Intrinsics.checkNotNullParameter(lobbyViewState, "it");
        return R.string.error_occurred_bluetooth_body;
    }
