    ...
    private int peekNumber() throws IOException {
        ...
        while (true) {
            ...
            if (b == 43) {
                ...
                if (c3 == c2 || c3 == 0) {
                    j = (long) (-(b + MessagePack.Code.INT8));
                    c3 = 2;
                } else if (c3 != 2) {
                    if (c3 == 3) {
                        i = 0;
                    ...
                    long j2 = (10 * j) - ((long) (b + MessagePack.Code.INT8));
    ...
    public BufferedSource nextSource() throws IOException {
        ...
        if (i2 == 3) {
            ...
            if (i2 == 9) {
                ...
                buffer2.writeUtf8(nextString());
            } else if (i2 == 5) {
                buffer2.writeUtf8("true");
            } else if (i2 == 6) {
                buffer2.writeUtf8("false");
            } else if (i2 == 7) {
                buffer2.writeUtf8("null");
            } else if (i2 == 11) {
                String nextString = nextString();
                JsonWriter of = JsonWriter.of(buffer2);
                try {
                    of.value(nextString);
                    if (of != null) {
                        of.close();
            ...
            this.valueSource = new JsonValueSource(this.source, buffer2, byteString, i);
            pushScope(9);
