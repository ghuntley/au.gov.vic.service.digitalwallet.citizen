...
public final class ReflectJvmMapping {
    ...
    public static final KProperty<?> getKotlinProperty(Field field) {
        ...
        Iterator it2 = KClasses.getMemberProperties(JvmClassMappingKt.getKotlinClass(field.getDeclaringClass())).iterator();
        while (true) {
            if (!it2.hasNext()) {
                break;
            }
    ...
    private static final KDeclarationContainer getKPackage(Member member) {
        ...
        KPackageImpl kPackageImpl = null;
        ...
        if (kind != null && ((i = WhenMappings.$EnumSwitchMapping$0[kind.ordinal()]) == 1 || i == 2 || i == 3)) {
            ...
            kPackageImpl = new KPackageImpl(declaringClass2, null, 2, null);
        }
        return kPackageImpl;
    }
    ...
    public static final KFunction<?> getKotlinFunction(Method method) {
        T t;
        boolean z;
        Intrinsics.checkNotNullParameter(method, "$this$kotlinFunction");
        Object obj = null;
        if (Modifier.isStatic(method.getModifiers())) {
            ...
            KClass<?> companionObject = KClasses.getCompanionObject(JvmClassMappingKt.getKotlinClass(method.getDeclaringClass()));
            if (companionObject != null) {
                ...
                while (true) {
                    ...
                    if (javaMethod != null && Intrinsics.areEqual(javaMethod.getName(), method.getName())) {
                        ...
                        if (Arrays.equals(parameterTypes, method.getParameterTypes()) && Intrinsics.areEqual(javaMethod.getReturnType(), method.getReturnType())) {
                            z = true;
                            continue;
                            if (z) {
                                break;
        ...
        Iterator<T> it3 = KClasses.getFunctions(JvmClassMappingKt.getKotlinClass(method.getDeclaringClass())).iterator();
        while (true) {
            if (!it3.hasNext()) {
                break;
            }
