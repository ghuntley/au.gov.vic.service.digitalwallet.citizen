...
public final /* synthetic */ class zzhq {
    ...
    static {
        ...
        try {
            zzb[zzlg.FLOAT.ordinal()] = 2;
        } catch (NoSuchFieldError unused2) {
        }
        try {
            zzb[zzlg.INT64.ordinal()] = 3;
        } catch (NoSuchFieldError unused3) {
        }
        try {
            zzb[zzlg.UINT64.ordinal()] = 4;
        } catch (NoSuchFieldError unused4) {
        }
        try {
            zzb[zzlg.INT32.ordinal()] = 5;
        } catch (NoSuchFieldError unused5) {
        }
        try {
            zzb[zzlg.FIXED64.ordinal()] = 6;
        } catch (NoSuchFieldError unused6) {
        }
        try {
            zzb[zzlg.FIXED32.ordinal()] = 7;
        } catch (NoSuchFieldError unused7) {
        }
        try {
            zzb[zzlg.BOOL.ordinal()] = 8;
        } catch (NoSuchFieldError unused8) {
        }
        zzb[zzlg.GROUP.ordinal()] = 9;
        zzb[zzlg.MESSAGE.ordinal()] = 10;
        zzb[zzlg.STRING.ordinal()] = 11;
        zzb[zzlg.BYTES.ordinal()] = 12;
        zzb[zzlg.UINT32.ordinal()] = 13;
        zzb[zzlg.SFIXED32.ordinal()] = 14;
        zzb[zzlg.SFIXED64.ordinal()] = 15;
        zzb[zzlg.SINT32.ordinal()] = 16;
        zzb[zzlg.SINT64.ordinal()] = 17;
        try {
            zzb[zzlg.ENUM.ordinal()] = 18;
