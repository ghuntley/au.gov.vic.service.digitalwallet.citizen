...
public abstract class zzii extends zzhq {
    ...
    public static class zza extends zzii {
        ...
        public final void zza(int i, zzkk zzkk, zzlc zzlc) throws IOException {
            ...
            zzb(zzi);
            zzlc.zza((Object) zzkk, (zzmr) this.zza);
        }
        ...
        public final void zza(long j) throws IOException {
            if (!zzii.zzc || zza() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.zze;
                    this.zze = i3 + 1;
                    zzma.zza(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.zzb;
                int i4 = this.zze;
    ...
    public final void zza(String str, zzmg zzmg) throws IOException {
        zzb.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) zzmg);
