...
public final class ExceptionsConstuctorKt {
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            ...
            num = Result.m12constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            num = Result.m12constructorimpl(ResultKt.createFailure(th));
        }
        Integer valueOf = Integer.valueOf(i);
        if (Result.m18isFailureimpl(num)) {
            num = valueOf;
        }
