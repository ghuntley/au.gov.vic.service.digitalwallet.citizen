...
public final class zzfr extends zzgq {
    ...
    private final void zza(zzfs<?> zzfs) {
        synchronized (this.zzg) {
            ...
            zzfv zzfv = this.zza;
            if (zzfv == null) {
                zzfv zzfv2 = new zzfv(this, "Measurement Worker", this.zzc);
                this.zza = zzfv2;
                zzfv2.setUncaughtExceptionHandler(this.zze);
                this.zza.start();
            } else {
                zzfv.zza();
            }
    ...
    public final void zzc(Runnable runnable) throws IllegalStateException {
        ...
        synchronized (this.zzg) {
            ...
            zzfv zzfv = this.zzb;
            if (zzfv == null) {
                zzfv zzfv2 = new zzfv(this, "Measurement Network", this.zzd);
                this.zzb = zzfv2;
                zzfv2.setUncaughtExceptionHandler(this.zzf);
                this.zzb.start();
            } else {
                zzfv.zza();
            }
