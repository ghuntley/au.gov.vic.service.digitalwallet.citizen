...
public final class JavaToKotlinClassMap {
    ...
    static {
        ...
        for (ClassId classId19 : CompanionObjectMapping.INSTANCE.allClassesWithIntrinsicCompanions()) {
            ...
            Intrinsics.checkNotNullExpressionValue(classId20, "ClassId.topLevel(FqName(…g() + \"CompanionObject\"))");
        ...
        for (int i = 0; i < 23; i++) {
            ...
            Intrinsics.checkNotNullExpressionValue(classId21, "ClassId.topLevel(FqName(…m.functions.Function$i\"))");
