            ...
            if ((r0.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    try {
                        ...
                        r0.L$4 = th;
                        r0.label = 2;
                        if (FlowKt__EmittersKt.invokeSafely$FlowKt__EmittersKt(new ThrowingCollector(th), function32, th, r0) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        throw th;
                    }
                    ...
                    Throwable th4 = (Throwable) r0.L$4;
                ...
                r0.L$3 = flowCollector;
                r0.label = 3;
                if (FlowKt__EmittersKt.invokeSafely$FlowKt__EmittersKt(new SafeCollector(flowCollector, r0.getContext()), function3, null, r0) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return Unit.INSTANCE;
            }
